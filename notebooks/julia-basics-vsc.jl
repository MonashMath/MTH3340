...
# ╔═╡ 4e3e18cf-4e62-4797-913b-27ff43328871
using LinearAlgebra

# ╔═╡ 2b4d5909-b805-4332-906f-c5e24c060440
using Plots
...
# ╔═╡ 0ad13671-1f9b-4f0c-851a-52be6a31c6a0
a = 10

# ╔═╡ 0241650c-6c1b-4332-9ab8-977ba6e82367
x = (a > 7)

# ╔═╡ 481f3f69-58da-47ba-907c-c66b549ca45d
!x

# ╔═╡ d1531cc4-780d-4da1-9df6-7bdad47c7478
y = (a > 2) && (a < 8)

# ╔═╡ 7de61d35-7118-47c1-8f4a-5897cd421184
z = (a > 2) || (a < 8)

# ╔═╡ 1c0b1e8d-dc07-4411-9c99-6bd390440d9f
q = a > 5 ?  10 : a + "hello" # short-circuited

# ╔═╡ 98c8b8a3-3f7f-4728-9614-bec6e0b255e1


# ╔═╡ af0a0dbf-4633-4725-8325-9077a837005f
md"## For loops
...
# ╔═╡ cd67a097-b7b6-4a5c-a3d6-40d268453624
begin 
	c = 0
...
# ╔═╡ a620fd47-912e-46e4-89f3-1f442b8c2ab4
c == 100*101/2

# ╔═╡ e9bf0007-474d-4058-8ff6-fcf958c71f5c
begin
   d = 0
   for i in 1:100
	   for j in 1:100
...
# ╔═╡ b8b874b1-4617-44f4-8013-b1869568824a
begin
   e = 0
...
# ╔═╡ fbd699e7-2b70-44d7-8e69-31fb0ce32ef8
d == e

# ╔═╡ 81837b46-c48a-496a-855f-bfbc15820ef3
begin 
	f = 0
	for i ∈ 1:10000
		α = 1/2^i
...
# ╔═╡ b9a2063c-2698-48c1-9452-dcd885994711
f

# ╔═╡ 262c655a-28c7-48df-9552-dc9bd35f54fa
md"## Functions
...
# ╔═╡ be9bf780-c7c4-41ca-917a-6bb0e0b0dfc4
β(m) = m == 1 ? 0 : 1

# ╔═╡ 410c9d7f-e913-481e-8c53-220c38e1f69f
...
# ╔═╡ 6a90fe84-f4cd-46b4-8ef3-50b63c755a50
Leibniz_formula(1)

# ╔═╡ 0e1d0f58-d8db-4e23-8d89-aca7b005c723
function Leibniz_formula_with_error(n)
	π_ap = Leibniz_formula(n)
	π_ap, π - π_ap
end

# ╔═╡ c395ae67-1ea1-44c5-aa80-5860aebadd12
Leibniz_formula_with_error(100000)

# ╔═╡ fd1ebf91-3921-4e12-b023-da7abacb0fd4
...
# ╔═╡ 03f081e9-ad64-40c3-8df8-29fc7ff21503
...
# ╔═╡ edbab39c-26e3-4ff4-934c-5c63c9b0b6c1
...
# ╔═╡ 66b40bda-7df9-47f9-9592-260251a004b0
...
# ╔═╡ 2cdf124f-02fd-47d8-9175-c9bd32bb2417
md"Now we call this function, using an anonymous function."

# ╔═╡ 9c552a7b-3ead-46d3-824b-a3656b48761b
bisection(x -> 3x^2-2,0,2) # x -

# ╔═╡ 642bacd8-900f-4546-9094-2eb7c0e809c7
md"## Arrays, vectors and matrices


"

# ╔═╡ b9f743cc-7201-48b7-8b04-b4dc18ff7978
md"## Arrays
...
# ╔═╡ 414a938b-d2e2-4142-9fcc-7c5064543965
A = [1 2 3; 4 5 6; 7 8 9] # an array constructor

# ╔═╡ 21a3dcdf-f1dd-4c6a-b3b1-9d3d8fe08420
B = [1.0, 2.0, 3.0] # a vector constructor, also with ;

# ╔═╡ 9121fede-0a98-46ee-832c-f22531224362
typeof(B)

# ╔═╡ eeacf3af-3307-4ef4-84a0-e35c0139265f
C = ["a" "b" "c"] # a row vector (1x3 matrix)

# ╔═╡ 1411612b-3c07-496a-8e3b-e1bc8c7b89e8
D = [1 2.3 4.5 5] # automatically using conversion in a clever way

# ╔═╡ 362e6ec1-0f10-4e47-9dc8-5c67d0703b49
E = ["Hello" 1 2.0 3]

# ╔═╡ 8c024823-e062-4ea5-a3a8-4ddcba1767a6
...
# ╔═╡ 9f2f26b9-c163-4d22-97c2-84bf74b11ef6
md"### Array comprehension

You can define arrays in a very concise way as follows"

# ╔═╡ 61474b3d-0e9a-4c8e-bcf4-436aef82b4ca
v = [1/n^2 for n in 1:10]

# ╔═╡ 8d653eab-8c0c-4db8-9928-fc56a94463e5
...
# ╔═╡ 293c7f20-9d9d-4f3b-b8f2-ce766757f52e
xv = 0:0.01:1

# ╔═╡ d030c6f3-a226-442d-bfe0-cf1c57e522bb
yv = sin.(2π*xv) + 0.1*sin.(16π*xv)

# ╔═╡ 4f9903dc-dc59-491b-82da-88ac6d554666
plot(xv,yv)
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "b895a36a472ee14e3bcfa3aebd9c640cd34396b9"
